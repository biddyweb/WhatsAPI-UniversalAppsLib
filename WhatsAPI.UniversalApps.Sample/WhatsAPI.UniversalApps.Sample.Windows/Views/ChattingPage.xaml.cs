using WhatsAPI.UniversalApps.Sample.Common;
using System;
...
namespace WhatsAPI.UniversalApps.Sample.Views
{
    ...
    public sealed partial class ChattingPage : Page
    {
        ...
        public ChattingPage()
        {
            ...
            this.navigationHelper.GoBackCommand = new WhatsAPI.UniversalApps.Sample.Common.RelayCommand(() => this.GoBack(), () => this.CanGoBack());
            //thisitemListView.SelectionChanged += itemListView_SelectionChanged;
