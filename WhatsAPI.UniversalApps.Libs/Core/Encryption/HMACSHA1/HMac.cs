...
namespace WhatsAPI.UniversalApps.Libs.Core.Encryption.HMACSHA1
{
    ...
    public abstract class HMAC : KeyedHashAlgorithm
    {
        ...
        internal WhatsAPI.UniversalApps.Libs.Core.Encryption.CryptoTools.BlockProcessor Block
        {
            get
            {
                if (_block == null)
                    _block = new WhatsAPI.UniversalApps.Libs.Core.Encryption.CryptoTools.BlockProcessor(_algo, (BlockSizeValue >> 3));
                return _block;
            }
        }
        ...
        {
            return (HMAC)Activator.CreateInstance(Type.GetType(algorithmName));
        }
    }
}
