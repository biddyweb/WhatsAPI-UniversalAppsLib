...
namespace WhatsAPI.UniversalApps.Libs.Core.Events
{
    public class EventBase
    {
        ...
        protected void fireOnGetGroups(GroupInfo[] groups)
        {
        ...
        protected void fireOnGetPrivacySettings(Dictionary<WhatsAPI.UniversalApps.Libs.Constants.Enums.VisibilityCategory, WhatsAPI.UniversalApps.Libs.Constants.Enums.VisibilitySetting> settings)
        {
        ...
        public delegate void OnGetPrivacySettingsDelegate(Dictionary<WhatsAPI.UniversalApps.Libs.Constants.Enums.VisibilityCategory, WhatsAPI.UniversalApps.Libs.Constants.Enums.VisibilitySetting> settings);
